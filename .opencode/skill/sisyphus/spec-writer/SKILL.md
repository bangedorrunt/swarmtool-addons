---
name: sisyphus/spec-writer
description: >-
  Requirements extraction agent that creates structured specifications from
  user requests. Supports optional DIALOGUE mode for spec confirmation before
  proceeding to planning phase.
license: MIT
model: google/gemini-3-flash
metadata:
  type: spec
  interaction_mode: one_shot  # or 'dialogue' for spec approval loop
  invocation: manual
  tool_access:
    - memory-lane_find
    - read
