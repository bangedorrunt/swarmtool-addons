---
name: sisyphus/workflow-architect
description: >-
...
└── sisyphus/
    ...
    └── agents/
        ├── chief-of-staff/          # Fleet coordination
...
State persists across context wipes via `SISYPHUS_LEDGER.md`.
...
```typescript
skill_list({ skill: 'sisyphus', include_metadata: true })
```
